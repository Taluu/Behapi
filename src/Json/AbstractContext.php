...
abstract class AbstractContext implements BehatContext
{
    ...
    public function path_should_be_readable(string $path): void
    {
    ...
    public function path_should_not_be_readable(string $path): void
    {
    ...
    public function the_json_path_collection_contains(string $path, string $value, $expected): void
    {
    ...
    public function the_json_path_should_be_a_valid_date(string $path): void
    {
        try {
    ...
    public function the_json_path_should_have_elements(string $path, int $count): void
    {
        Assert::count($this->getValue($path), $count);
    }

    /** @Then in the json, :path should have at most :count element(s) */
    public function the_json_path_should_have_at_most_elements(string $path, int $count): void
    {
        $value = $this->getValue($path);
    ...
    public function the_json_path_should_match(string $path, string $pattern): void
    {
     ...
     */
    public function the_json_path_should_not_match(string $path, string $pattern): void
    {
    ...
    public function root_should_be_an_array(): void
    {
        Assert::isArray($this->getJson());
    }

    /** @Then in the json, the root should have :count element(s) */
    public function the_root_should_have_elements(int $count): void
    {
        $value = $this->getJson();
    ...
    public function the_root_should_have_at_most_elements(int $count): void
    {
        $value = $this->getJson();
    ...
    public function the_json_path_should_be_a_valid_json_encoded_string(string $path): void
    {
